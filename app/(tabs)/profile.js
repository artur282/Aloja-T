  ...
  const handleSelectProfilePhoto = async () => {
    try {
      ...
      if (!result.canceled && result.assets && result.assets.length > 0) {
        const { error, publicUrl } = await uploadProfilePhoto(result.assets[0].uri);
        ...
        <View style={styles.infoHeader}>
          ...
          {!isEditing ? (
            ...
            >
              ...
              <Text style={[styles.editButtonText, { color: COLORS.error }]}>Cancelar</Text>
            </TouchableOpacity>
          )}
        </View>
        ...
        {isEditing ? (
          ...
          <View style={styles.infoDetails}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{user.numero_telefono || 'No especificado'}</Text>
            </View>
            
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Documento de identidad:</Text>
              <Text style={styles.infoValue}>{user.documento_identidad || 'No especificado'}</Text>
            </View>
              ...
              <View style={styles.verificationContainer}>
                {user.estado_verificacion ? (
                  <>
                    ...
                    <Text style={[styles.infoValue, { color: COLORS.secondary, marginLeft: 5 }]}>
                      Verificado
                    </Text>
                  </>
                ) : (
                  <>
                    <FontAwesome name="exclamation-circle" size={16} color={COLORS.accent} />
                    <Text style={[styles.infoValue, { color: COLORS.accent, marginLeft: 5 }]}>
                      Pendiente
                    </Text>
                  </>
                )}
